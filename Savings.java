...
public class Savings extends Account{
	...
	public Savings(String name, String ssn, double balance) {
		...
		this.savingsAccountID = (int) (100 + Math.random() * 999);
		this.savingsAccountPIN = (int) (1000 + Math.random() * 9999);
		setInterestRate();
	}
	 ...
	 * 
	 * Savings account interest rate must be set to 0.25% less the baseInterestRate
	 * declared in Account class
	 */
	// setInterestRate() method definition and implementation goes here

	public double setInterestRate() {
		return super.interestRate - 0.25;
	}
